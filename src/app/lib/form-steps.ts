...
export const PERSONAL_STEPS: FormStep[] = [
  ...
  },
  {
    ...
    order: 7,
    title: "FEE BANK",
    description: "Referral and fee payment bank account details.",
    fields: [
      { id: "f37s", type: "section", label: "Referral" },
      { id: "f38", label: "Recommended by", name: "referral", type: "text", width: "full" },
      { id: "f39s", type: "section", label: "Information on the bank account from which the fee is being paid (if applicable)" },
